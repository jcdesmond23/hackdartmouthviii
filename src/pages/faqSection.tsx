...
export default function FaqSection() {
  return (
    <>
      <div id="faq" className="h-[660px] sm:h-[982px] overflow-hidden">
        <h1 className="pl-12 sm:pl-24 pt-5 sm:pt-12 font-black text-2xl sm:text-4xl lg:text-6xl text-[#EEE9D7] tracking-widest">
          FAQ
        </h1>
        <div className="flex flex-row px-8 sm:px-16 mt-6 sm:mt-12 mb-2 sm:mb-4 mx-auto">
          <div className="flex flex-col flex-1 text-xs sm:text-sm px-4 sm:px-8">
          ...
          <div className="flex flex-col flex-1 sm:text-sm px-4 sm:px-8 text-xs px-4">
